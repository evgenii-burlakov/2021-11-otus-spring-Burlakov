...
public final class QuestionTestData {
    ...
    public static final Question QUESTION1 = new Question("en-EN", 1, QuestionType.ANSWER_OPTIONS, "What does the squirrel eat?", List.of(QUESTION_ANSWER1, QUESTION_ANSWER2, QUESTION_ANSWER3));
    public static final Question QUESTION2 = new Question("en-EN", 2, QuestionType.FREE_ANSWER, "The capital of England?", List.of(QUESTION_ANSWER4));
    public static final Question QUESTION3 = new Question("en-EN", 3, QuestionType.ANSWER_OPTIONS, "Who lives in a pineapple under the sea?", List.of(QUESTION_ANSWER5, QUESTION_ANSWER6));
    public static final Question QUESTION4 = new Question("en-EN", 4, QuestionType.FREE_ANSWER, "The name of our planet?", List.of(QUESTION_ANSWER7));
    public static final Question QUESTION5 = new Question("en-EN", 5, QuestionType.FREE_ANSWER, "What programming language was this test written in?", List.of(QUESTION_ANSWER8));
