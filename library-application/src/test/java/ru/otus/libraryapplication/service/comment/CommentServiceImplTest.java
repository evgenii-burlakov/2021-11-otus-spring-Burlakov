...
import ru.otus.libraryapplication.repositories.comment.CommentRepositoryJpa;
...
class CommentServiceImplTest {
    ...
    void shouldCorrectGetAllComments() {
        ...
        Mockito.when(commentRepositoryJpa.getAllByBook(BOOK1)).thenReturn(List.of(COMMENT1, COMMENT2, COMMENT3));
    ...
    void shouldThrowExceptionWhenBookNotExist() {
        ...
        Mockito.verify(commentRepositoryJpa, Mockito.never()).deleteById(Mockito.anyLong());
    }
    ...
    void shouldCorrectDeleteComment() {
        ...
        Mockito.verify(commentRepositoryJpa, Mockito.times(1)).deleteById(1L);
    }
    ...
    void shouldCorrectCreateComment() {
        ...
        Mockito.verify(commentRepositoryJpa, Mockito.times(1)).create(new Comment(null, "Это что за книга?", BOOK1));
    }
